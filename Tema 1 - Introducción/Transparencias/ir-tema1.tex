...
\begin{frame}[c]
    \frametitle{Índice}
    \begin{enumerate}
         \item \alert<2>{Objetivos y Necesidad de la Ingeniería de Requisitos}.
         \item Terminología Básica.
         \item Procesos de Ingeniería de Requisitos.
         \item Ingeniería de Requisitos en los Procesos de Desarrollo.
...
\begin{frame}[c]
    \frametitle{Índice}
    \begin{enumerate}
         \item Objetivos y Necesidad de la Ingeniería de Requisitos.
         \item \alert{Terminología Básica}.
         \item Procesos de Ingeniería de Requisitos.
         \item Ingeniería de Requisitos en los Procesos de Desarrollo.
         \item Sumario y Referencias.
    \end{enumerate}
...
\begin{frame}
    ...
    \begin{block}{Esencia de un Sistema~\cite{mcmenamin:1984}}
        La \alert{\emph{esencia de un sistema sw}} es el conjunto de requisitos sw que indican las capacidades o características esenciales  que debe poseer un sistema sw para satisfacer su objetivo, con independencia de como se implemente dicho sistema.
    \end{block}
    \uncover<2-> {
        \begin{block}{Encarnación de un Sistema~\cite{mcmenamin:1984}}
            La \alert{\emph{encarnación de un sistema sw}} es todo aquello que es necesario para la implementación y fubncionamiento de un sistema sw, desde su concepción, hasta el fin de su vida útil.
        \end{block}
    }
\end{frame}
...
\begin{frame}[c]
    ...
    \begin{enumerate}
         \item Objetivos y Necesidad de la Ingeniería de Requisitos.
         \item Terminología Básica.
         \item \alert{Procesos de Ingeniería de Requisitos}.
         \item Ingeniería de Requisitos en los Procesos de Desarrollo.
         \item Sumario y Referencias.
    \end{enumerate}
\end{frame}
...
\begin{frame}[c]
    ...
    \begin{enumerate}
         ...
         \item Terminología Básica.
         \item Procesos de Ingeniería de Requisitos.
         \item \alert{Ingeniería de Requisitos en los Procesos de Desarrollo}.
         \item Sumario y Referencias.
    \end{enumerate}
\end{frame}
