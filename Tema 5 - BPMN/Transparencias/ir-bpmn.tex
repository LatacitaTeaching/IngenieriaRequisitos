...
\begin{frame}[c]
    \begin{block}{Pool}
        ...
        \ \\
        \begin{center}
            \includegraphics[width=0.25\textwidth]{symbols/pool.eps}
        \end{center}
    \end{block}
    \begin{block}{Lane}
        ...
        \ \\
        \begin{center}
            \includegraphics[width=0.25\textwidth]{symbols/lane.eps}
        \end{center}
    \end{block}
\end{frame}
...
\begin{frame}[c]
    \frametitle{Eventos y Tareas}
    \begin{block}{Evento}
        Un \alert{\emph{evento}} es algo que ocurre durante el curso de un proceso de negocio. \uncover<2->{Un evento sucede a consecuencia de una causa (\emph{trigger}) y puede poseer un impacto (\emph{result}).}
        \uncover<3->{Los eventos puede ser de \emph{inicio}, \emph{intermedios} o de \emph{finalización}.}
        \begin{columns}
        \begin{column}{width=0.33\textwidth}
            \begin{center}
                \includegraphics[width=0.50\textwidth]{symbols/startEvent.eps}
            \end{center}
        \end{column}
        \begin{column}{width=0.33\textwidth}
            \begin{center}
                \includegraphics[width=0.50\textwidth]{symbols/intermediateEvent.eps}
            \end{center}
        \end{column}
        \begin{column}{width=0.33\textwidth}
            \begin{center}
                \includegraphics[width=0.50\textwidth]{symbols/endEvent.eps}
            \end{center}
        \end{column}
    \end{block}
    \begin{block}{Tarea}
        Una \alert{\emph{tarea}} es una unidad de trabajo atómica realizada por una entidad dentro de un proceso de negocio.
        \ \\
        \begin{center}
            \includegraphics[width=0.25\textwidth]{symbols/task.eps}
        \end{center}
    \end{block}
\end{frame}
...
\begin{frame}[c]
    ...
    \begin{block}{Sequence Flow}
        ...
        \ \\
        \begin{center}
            \includegraphics[width=0.5/textwidth]{symbols/sequenceFlow.eps}
        \end{center}
    \end{block}
    \begin{block}{Message Flow}
        ...
        \ \\
        \begin{center}
            \includegraphics[width=0.5/textwidth]{symbols/messageFlow.eps}
        \end{center}
    \end{block}
\end{frame}
...
\begin{frame}[c]
    ...
    \begin{center}
        \includegraphics[width=\linewidth]{symbols/eventKinds.eps}
    \end{center}
\end{frame}
...
\begin{frame}[c]
    ...
    \begin{block}{Gateways}
        ...
        \ \\
        \begin{center}
            \includegraphics[width=0.25\text]{symbols/gateway.eps}
        \end{center}
    \end{block}
    \begin{block}{Conditional Flow}
        ...
        \ \\
        \begin{center}
            \includegraphics[width=0.5/textwidth]{symbols/conditionalFlow.eps}
        \end{center}
    \end{block}
    \begin{block}{Default Flow}
        ...
        \ \\
        \begin{center}
            \includegraphics[width=0.5/textwidth]{symbols/defaultFlow.eps}
        \end{center}
    \end{block}
\end{frame}
...
\begin{frame}[c]
    ...
    \begin{center}
            \includegraphics[width=\linewidth]{symbols/gatewayKinds.eps}
    \end{center}
\end{frame}
