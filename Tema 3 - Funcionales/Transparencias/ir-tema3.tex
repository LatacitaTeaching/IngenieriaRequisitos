\documentclass[handout,slidestop,xcolor=pst,dvips,blue]{beamer}
...
\begin{frame}[c]
    ...
    \begin{enumerate}[<+->]
         ...
         \item Ser capaz de descomponer jerárquicamente requisitos, utilizando tanto objetivos como escenarios.
         \item Ser capaz de especificar requisitos de alto nivel utilizando objetivos.
         \item Ser capaz de especificar requisitos utilizando casos de uso.
         \item Ser capaz de especificar requisitos utilizando historias de usuario.
...
%		%% Positivo: Satisface un objetivo. 
%		%% Negativo: No se satisface el objetivo.
...
\begin{frame}[c]
    ...
    \begin{enumerate}[<+->]
        ...
        %% NOTA: Si es necesario se pueden meter frases como "tan pronto como ... ", "en cualquier momento ..."
